...
replaceitem entity @s hotbar.1 tac:timeless_50{AmmoCount:7,Tags:["kill","team_fight_tw2"]}
replaceitem entity @s inventory.9 tac:ae50{Tags:["kill","team_fight_tw9_12"]} 14
#防止套娃
...
tellraw @s [{"text":"[","bold":true},{"text":"提示","bold":true,"color":"green"},{"text":"]: ","bold":true,"color":"white"},{"text":"已使用技能 ","bold":false},{"text":"战场补给","bold":true,"color":"red"}]