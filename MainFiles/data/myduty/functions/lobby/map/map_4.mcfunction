...
data merge block 182 5 201 {Color:"black",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"italic":false,"color":"black","clickEvent":{"action":"run_command","value":"execute if score #mode start matches 0 run function myduty:lobby/map/map_5"},"text":">>>"}',Text1:'{"text":""}'}
data merge block 184 5 201 {Color:"black",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"italic":false,"color":"black","clickEvent":{"action":"run_command","value":"execute if score #mode start matches 0 run function myduty:lobby/map/map_3"},"text":"<<<"}',Text1:'{"text":""}'}
