replaceitem entity @s hotbar.1 tac:cz75_auto{AmmoCount:16,Tags:["kill","team_fight_tw2"]}
replaceitem entity @s inventory.9 tac:9mm_round{Tags:["kill","team_fight_tw9_12"]} 32


scoreboard players set @s team_fight_shop 0
scoreboard players set @s revive_thing_fwq 25
