replaceitem entity @s hotbar.1 tac:m92fs{AmmoCount:20,Attachments:{PistolBarrel:{id:"tac:pistol_silencer",Count:1b,tag:{Tags:["ban"]}},Extended_Mag:{id:"tac:small_extended_mag",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw2"]}
replaceitem entity @s inventory.9 tac:9mm_round{Tags:["kill","team_fight_tw9_12"]} 38


scoreboard players set @s team_fight_shop 0
scoreboard players set @s revive_thing_fwq 24
