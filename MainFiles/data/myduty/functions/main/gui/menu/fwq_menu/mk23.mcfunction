replaceitem entity @s hotbar.1 tac:mk23{AmmoCount:12,Attachments:{PistolScope:{id:"tac:mini_dot",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw2"]}
replaceitem entity @s inventory.9 tac:round45{Tags:["kill","team_fight_tw9_12"]} 24


scoreboard players set @s team_fight_shop 0
scoreboard players set @s revive_thing_fwq 27
