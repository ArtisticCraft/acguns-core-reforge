replaceitem entity @s hotbar.0 tac:mp9{AmmoCount:26,CurrentFireMode:2,Attachments:{PistolScope:{id:"tac:mini_dot",Count:1b,tag:{Tags:["ban"]}},Extended_Mag:{id:"tac:small_extended_mag",Count:1b,tag:{Tags:["ban"]}},Side_Rail:{id:"tac:basic_laser",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 32
replaceitem entity @s inventory.1 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 31
replaceitem entity @s inventory.2 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 31
replaceitem entity @s inventory.3 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 31

scoreboard players set @s team_fight_shop 0
scoreboard players set @s revive_thing 31
