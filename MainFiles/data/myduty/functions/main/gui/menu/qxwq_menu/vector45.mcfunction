replaceitem entity @s hotbar.0 tac:vector45{AmmoCount:23,CurrentFireMode:2,Attachments:{Stock:{id:"tac:light_stock",Count:1b,tag:{Tags:["ban"]}},Extended_Mag:{id:"tac:small_extended_mag",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:round45{Tags:["kill","team_fight_tw18"]} 41
replaceitem entity @s inventory.1 tac:round45{Tags:["kill","team_fight_tw18"]} 40
replaceitem entity @s inventory.2 tac:round45{Tags:["kill","team_fight_tw18"]} 40
replaceitem entity @s inventory.3 tac:round45{Tags:["kill","team_fight_tw18"]} 40

scoreboard players set @s team_fight_shop 0
scoreboard players set @s revive_thing 35
