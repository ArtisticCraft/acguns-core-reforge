replaceitem entity @s hotbar.8 carrot_on_a_stick{Tags:["skill"],CustomModelData:3,display:{Name:'[{"text":"紧急复苏","color":"red","italic": false,"bold": true},{"text":"(右键使用)","color":"dark_gray","italic": false,"bold": false}]',Lore:['[{"text":"-=[","color":"yellow","italic": false},{"text":"技能","color":"aqua","italic": false},{"text":"]=-","color":"yellow","italic": false}]','{"text":"使用后立即开始恢复血量","color":"dark_gray","italic": false,"bold": true}']}}

scoreboard players set @s team_fight_skill 0
scoreboard players set @s revive_thing_sk 52
