replaceitem entity @s hotbar.0 tac:ak47{AmmoCount:30,CurrentFireMode:2,Attachments:{Scope:{id:"tac:coyote_sight",Count:1b,tag:{Tags:["ban"]}},Stock:{id:"tac:light_stock",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
...
scoreboard players set @s revive_thing 10
