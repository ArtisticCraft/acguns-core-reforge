replaceitem entity @s hotbar.0 tac:hk_g3{AmmoCount:20,CurrentFireMode:2,Attachments:{Barrel:{id:"tac:muzzle_brake",Count:1b,tag:{Tags:["ban"]}},Stock:{id:"tac:weighted_stock",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
...
scoreboard players set @s revive_thing 106
