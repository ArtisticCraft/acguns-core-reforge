replaceitem entity @s hotbar.0 tac:m16a4{AmmoCount:30,CurrentFireMode:3,Attachments:{Barrel:{id:"tac:muzzle_brake",Count:1b,tag:{Tags:["ban"]}},Scope:{id:"tac:coyote_sight",Count:1b,tag:{Tags:["ban"]}},Under_Barrel:{id:"tac:light_grip",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:nato_556_bullet{Tags:["kill","team_fight_tw18"]} 24
replaceitem entity @s inventory.1 tac:nato_556_bullet{Tags:["kill","team_fight_tw18"]} 22
replaceitem entity @s inventory.2 tac:nato_556_bullet{Tags:["kill","team_fight_tw18"]} 22
replaceitem entity @s inventory.3 tac:nato_556_bullet{Tags:["kill","team_fight_tw18"]} 22

scoreboard players set @s team_fight_shop 0
scoreboard players set @s revive_thing 105
