replaceitem entity @s hotbar.0 tac:m24{AmmoCount:5,Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:win_30-30{Tags:["kill","team_fight_tw18"]} 5
replaceitem entity @s inventory.1 tac:win_30-30{Tags:["kill","team_fight_tw18"]} 5
replaceitem entity @s inventory.2 tac:win_30-30{Tags:["kill","team_fight_tw18"]} 5
replaceitem entity @s inventory.3 tac:win_30-30{Tags:["kill","team_fight_tw18"]} 5

scoreboard players set @s team_fight_shop 0
scoreboard players set @s revive_thing 15
