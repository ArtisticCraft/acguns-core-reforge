replaceitem entity @s hotbar.0 tac:scar_h{AmmoCount:20,CurrentFireMode:1,Attachments:{Scope:{id:"tac:qmk152",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
...
scoreboard players set @s revive_thing 102
