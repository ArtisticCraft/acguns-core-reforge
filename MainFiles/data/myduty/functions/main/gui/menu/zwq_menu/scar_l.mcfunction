replaceitem entity @s hotbar.0 tac:scar_l{AmmoCount:30,CurrentFireMode:2,Attachments:{Barrel:{id:"tac:muzzle_brake",Count:1b,tag:{Tags:["ban"]}},Under_Barrel:{id:"tac:light_grip",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
...
scoreboard players set @s revive_thing 13
