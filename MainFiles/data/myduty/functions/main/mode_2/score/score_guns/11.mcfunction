replaceitem entity @s hotbar.0 tac:rpk{AmmoCount:40,CurrentFireMode:2,Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:762x39{Tags:["kill","team_fight_tw18"]} 30
replaceitem entity @s inventory.1 tac:762x39{Tags:["kill","team_fight_tw18"]} 30
replaceitem entity @s inventory.2 tac:762x39{Tags:["kill","team_fight_tw18"]} 30
replaceitem entity @s inventory.3 tac:762x39{Tags:["kill","team_fight_tw18"]} 30
