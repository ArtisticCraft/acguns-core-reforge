replaceitem entity @s hotbar.0 tac:cz75_auto{AmmoCount:16,CurrentFireMode:2,Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 12
replaceitem entity @s inventory.1 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 12
replaceitem entity @s inventory.2 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 12
replaceitem entity @s inventory.3 tac:9mm_round{Tags:["kill","team_fight_tw18"]} 12
