replaceitem entity @s hotbar.0 tac:m1911{AmmoCount:7,Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:round45{Tags:["kill","team_fight_tw18"]} 6
replaceitem entity @s inventory.1 tac:round45{Tags:["kill","team_fight_tw18"]} 6
replaceitem entity @s inventory.2 tac:round45{Tags:["kill","team_fight_tw18"]} 6
replaceitem entity @s inventory.3 tac:round45{Tags:["kill","team_fight_tw18"]} 6
