replaceitem entity @s hotbar.0 tac:m82a2{AmmoCount:5,Attachments:{Scope:{id:"tac:8x_scope",Count:1b,tag:{Tags:["ban"]}}},Tags:["kill","team_fight_tw1"]}
replaceitem entity @s inventory.0 tac:50bmg{Tags:["kill","team_fight_tw18"]} 4
replaceitem entity @s inventory.1 tac:50bmg{Tags:["kill","team_fight_tw18"]} 4
replaceitem entity @s inventory.2 tac:50bmg{Tags:["kill","team_fight_tw18"]} 4
replaceitem entity @s inventory.3 tac:50bmg{Tags:["kill","team_fight_tw18"]} 3
