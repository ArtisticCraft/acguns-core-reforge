scoreboard players operation #t_score t_score_show = #mode_3_score_set mode_3_score_set
tag @a add gameover
...
title @a subtitle {"text": "","extra":[{"text": "MVP: "},{"selector": "@a[tag=mvp_red,limit=1]"}]}
