...
tellraw @a [{"text":"[","bold":true},{"text":"注意","bold":true,"color":"gold"},{"text":"]","bold":true,"color":"white"},{"text":":","bold":true},{"text":" C4已被拆除!","color":"red"}]
...
title @a subtitle {"text": "","extra":[{"text": "MVP: "},{"selector": "@a[tag=c4_defuse,limit=1]"},{"text": " 拆除了C4炸弹"}]}
