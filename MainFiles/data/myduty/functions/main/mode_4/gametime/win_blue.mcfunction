...
execute if entity @a[team=blue,scores={kda_k_4=1..}] run title @a subtitle {"text": "","extra":[{"text": "MVP: "},{"selector": "@a[tag=mvp_blue_4,limit=1]"}]}
execute unless entity @a[team=blue,scores={kda_k_4=1..}] run title @a subtitle {"text": "","extra":[{"text": "时间耗尽"}]}
